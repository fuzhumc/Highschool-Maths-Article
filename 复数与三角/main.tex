...
\begin{align*}
    \lrvert{z_3} & = \sqrt{\lrvert{z_1}^2 + \lrvert{z_2}^2 + 2 \lrvert{z_1} \lrvert{z_2} \cos (\alpha - \beta)} \\
...
\begin{equation*}
    \lrvert{1 - \xi^k} = 2 \sin \dfrac{k \pi}{n}, \quad
    \lrvert{1 + \xi^k} = 2 \lrvert{\cos \dfrac{k \pi}{n}}
\end{equation*}
